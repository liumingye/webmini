...
import { ComponentOptions, DefineComponent, inject, provide } from 'vue'
...
// 图标Wrapper
export function IconWrapper(name: string, rtl: boolean, render: IconRender): Plugin {
  const options: IconOptions = {
    ...
    setup: (props) => {
      ...
      return () => {
        const { size, strokeWidth, strokeLinecap, strokeLinejoin, theme, fill, spin } = props
